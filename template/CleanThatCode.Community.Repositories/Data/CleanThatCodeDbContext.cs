    ...
    public IEnumerable<Comment> Comments =>
        [
            new Comment
            {
                ...
                Created = DateTime.Parse("08/12/2016 10:00:07", CultureInfo.InvariantCulture)
            },
            new Comment
            {
                Id = 2,
                ...
                Created = DateTime.Parse("08/14/2016 13:22:15", CultureInfo.InvariantCulture)
            },
            new Comment
            {
                Id = 3,
                ...
                Created = DateTime.Parse("12/22/2017 22:21:08", CultureInfo.InvariantCulture)
            },
            new Comment
            {
                Id = 4,
                ...
                Created = DateTime.Parse("12/22/2017 22:55:41", CultureInfo.InvariantCulture)
            },
            new Comment
            {
                Id = 5,
                ...
                Created = DateTime.Parse("12/23/2017 12:36:09", CultureInfo.InvariantCulture)
            }
        ];
    ...
    public IEnumerable<Post> Posts =>
        [
            new Post
            {
                ...
                Created = DateTime.Parse("08/11/2016 11:17:04", CultureInfo.InvariantCulture),
                NumberOfLikes = 5
            },
            new Post
            {
                ...
                Created = DateTime.Parse("12/22/2017 16:44:24", CultureInfo.InvariantCulture),
                NumberOfLikes = 10
            }
        ];
}
