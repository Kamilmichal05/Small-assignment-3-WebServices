    ...
    public static IEnumerable<Post> Posts =>
        [
            ...
            new Post
            {
                ...
                Created = DateTime.Parse("08/11/2018 11:17:04", CultureInfo.InvariantCulture),
                NumberOfLikes = 112
            },
            new Post
            {
                ...
                Created = DateTime.Parse("10/11/2018 11:17:04", CultureInfo.InvariantCulture),
                NumberOfLikes = 1
            },
            new Post
            {
                ...
                Created = DateTime.Parse("08/22/2018 13:22:34", CultureInfo.InvariantCulture),
                NumberOfLikes = 992
            }
        ];
